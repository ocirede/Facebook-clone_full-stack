...
import { faUser, faHouse, faCog, faCheese, faMoon, faTv, faShop, faUserGroup, faGamepad, faCubesStacked, faMessage, faBell, faEdit, faComment, faDoorOpen } from '@fortawesome/free-solid-svg-icons';
 ...
 const Navigation = () => {
  ...
  return (
    ...
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Facebook_Logo_%282019%29.png/600px-Facebook_Logo_%282019%29.png" className='h-12 pl-3 md:pl-2 sm:pl-2' alt="" />
    <div>
...
<div className="w-2/4 flex items-center justify-between  border-b border-gray-300">
    ...
    <div
      ...
      <div
        className={getTabStyle(6)}
        onClick={() => handleTabClick(6)}
      >
        <FontAwesomeIcon icon={faMessage} size="xl" />
      </div>
      <div
        className={getTabStyle(7)}
        ...
        {isDropdownOpen && (
                        ...
                        >
                          ...
                          <button className="block w-full text-left py-4 px-4 hover:bg-gray-200">
                            <FontAwesomeIcon icon={faCheese} className="mr-2" /> Meta Business Suite
                          </button>
                          <button className="block w-full text-left py-4 px-4 hover:bg-gray-200">
                            <FontAwesomeIcon icon={faCog} className="mr-2" /> Settings & privacy
                          </button>
                          <button className="block w-full text-left py-4 px-4 hover:bg-gray-200">
                            <FontAwesomeIcon icon={faEdit} className="mr-2" /> Help & support
                          </button>
                          <button className="block w-full text-left py-4 px-4 hover:bg-gray-200">
                            <FontAwesomeIcon icon={faMoon} className="mr-2" /> Display & accessibility
                          </button>
                          <button className="block w-full text-left py-4 px-4 hover:bg-gray-200">
                            <FontAwesomeIcon icon={faComment} className="mr-2" /> Give feedback
                          </button>
                          <button className="block w-full text-left py-4 px-4 hover:bg-gray-200" onClick={handleLogout}>
                            <FontAwesomeIcon icon={faDoorOpen} className="mr-2" /> Log out
                          </button>
                        </div>
                      )}
        </div>
